...
% Official TU Dresden 2025 theme (compact by default; wrapper can select spread)
\ifdefined\TUDDemoSpreadFootline
  \usepackage[headprogress=true,footline=spread]{beamerthemeTUDofficial2025}
\else
...
% Title info
\title[Official Theme Demo]{TUD Official 2025 — Brillantblau Theme}
\subtitle{Clean footline, geometric accent}
\author[Presentation Team]{Author One \\ Author Two}
